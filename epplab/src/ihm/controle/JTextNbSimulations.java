...
/*---------------------------*/
/* Classe JTextNbSimulations */
/*---------------------------*/
/**
 * La classe <code>JTextNbSimulations</code> ...
 *
 * @author	Alain Berro, Emilie Chabbert
 * @version	28 mars 2010
 */
public final class JTextNbSimulations extends JTextField implements CaretListener, FocusListener
{
	/*---------*/
	/* Données */
	/*---------*/
	...
	/*--------------*/
	 ...
	 public JTextNbSimulations (Recherche c)
		{
		super(4);
	...
	public void caretUpdate (CaretEvent ce)
		...
		try	{
			...
			if	(i <= 0)
				...
				this.valeur = i;
				this.ctrl.getParametre().nbSimulation = i;
				this.erreur = false;
				}
			}
...
} /*----- Fin de la classe JTextNbSimulations -----*/
