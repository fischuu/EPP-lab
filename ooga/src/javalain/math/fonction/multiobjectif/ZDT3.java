...
/*---------------*/
/**
 * Fonction multiobjectif ZDT3.
 *  - x1...xn [0,1] avec n = 30 (par défaut)
 *  - Front de Pareto discontinue
 *  - Pas d'optimum local
 *
 * Minimiser :
 *  f1(x) = x1
 ...
 */
public final class ZDT3 extends Fct
{
	/*--------------*/
	/* Constructeur */
	/*--------------*/
	...
	private final static double cte = 10.0*Math.PI;
	...
	private static double f (double f1, double g)
		{
		return 1.0 - Math.sqrt(f1/g) - Math.sin(cte*f1)*f1/g;
		}
